...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7dba02af0b88137e6c25b82b3345e1a0a64dd9cc996177a47f59fa41d427da79.js',function(){input.required=false;search();});}
