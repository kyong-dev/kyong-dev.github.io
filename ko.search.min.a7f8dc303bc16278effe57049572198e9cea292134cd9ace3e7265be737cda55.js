...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.0928fa104fe3476599c29a648c3b43887ab15c935b67385bf7ca4d4bf2cc6db9.js',function(){input.required=false;search();});}
