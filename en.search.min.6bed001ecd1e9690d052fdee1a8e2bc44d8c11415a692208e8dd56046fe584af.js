...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ab8012a4b0913cc03a9cf46dddb34ca172ff32d0ee8564e6dd0391633dbfb283.js',function(){input.required=false;search();});}
