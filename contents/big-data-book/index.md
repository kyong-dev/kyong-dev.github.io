...
## 21장. 내러티브 사이언스 (Narrative Science)
자연어생성 AI를 이용해 보고서를 만드는 등 부동산이나 재무 데이터를 이용해 각종 서비스를 제공하는데 사용되고 있다.

## 22장. 영국공영방송 (BBC)
시청자들의 행동 데이터를 수집하고 연구해 시청자들이 보고싶어 하는 프로그램을 제작하는데 빅데이터를 이용하고 있으며 광고주들이 보다 효율적으로 타겟광고를 할 수 있도록 도움을 줘 만족감을 주고 있다.

## 23장. 밀턴 케인스 (Milton Keynes)
밀턴 케인스는 인구가 작은 영국 중부의 작은 도시이다. 빅데이터를 활용해 스마트 시티 건설을 할 계획을 가지고 설계 단계에 있다. 스마트하게 인프라 개발하는 것은 단기 비용은 초래할 수 있지만 장기적으로는 비용 절감을 가져올 수 있을 거라 믿는다.

## 24장. 팔란티어 (Palantir)
닥치는대로 전세계의 데이터를 수집해 미국 국가안보국에 제공함으로써 테러 및 각종 위협에 대처하는 것에 도움을 주고 있다. 하지만 여전히 개인정보 보호는 아직도 빅데이터 세계의 어두운 영역이다.

## 25장. 에어비앤비 (Airbnb)
회원들의 휴일 습관과 숙박시설 선호도에 대한 엄청난 양의 정보를 수집하였고, 이상적인 숙박시설을 합리적인 가격으로 제공할 수 있도록 집주인들에게 가이드를 제공한다. 이 결과 집주인과 이용자가 모두 만족할만한 결과를 가져다 주었다.

## 26장. 스프린트 (Sprint)
네트워크로 인증된 자사의 데이터를 사용해 더 정확하고 믿을 수 있는 소비자 행동에 대한 프로필을 만들었고, 광고주에게 더 정확한 타깃 고객을 제공할 수 있었다.

## 27장. 디키스 바비큐 피트 (Dickey's Barbecue Pit)
스모크 스택(Smoke Stack)이라는 자사 빅데이터 시스템을 만들어 사업에 유용한 통찰력을 얻고 매출을 올리려는 목적으로 사용되고 있다. 그 의도는 적중해 사업 운영, 마케팅, 직원 교육, 브랜드 관리 및 메뉴 개발을 포함한 전반에 걸쳐 효율성을 향상시켰다.

## 28장. 시저스 (Caesars)
카지노, 호텔, 레스토랑 등에서 소비자들의 행동분석을 통해 서비스를 개선해 고객 만족과 지속적인 소비를 불러오게 했다.

## 29장. 핏비트 (Fitbit)
웨어러블 피트니스 시장의 선두주자로서 사용자의 촬동, 운동, 칼로리 섭취 그리고 수면을 추적해 정보를 제공해 사용자 스스로를 모니터링하고 자신의 생활습관을 개선할 수 있도록 도와준다.

## 30장. 랄프 로렌 (Ralph Lauren)
셔츠 안쪽에 센서를 부착해 움직이는 방향, 동작, 심박수 같은 생체 측정 데이터도 수집해 사용자에 알맞은 유산소 운동과 근렴 및 민첩성 운동 값을 생성한다.

## 31장. 징가 (Zynga)
게임에서 일어난 모든 것에 대한 정형화된 데이터를 수집한다. 그리고 데이터 기반의 의사결정으로 큰 성공을 거두었다.

## 32장. 오토데스크 (Autodesk)
오토캐드를 제작한 회사로 제품이 클라우드에 호스팅되면서, 고객들이 제품과 어떻게 상호작용하는지에 대한 모든 양상을 추적하고 면밀히 모니터링할 수 있게 되었다. 그리고 개발 초점이 고객 지원과 상당수의 사용자층이 자주 사용하는 기능을 향상시키는 쪽으로 이동할 수 있었다.

## 33장. 월트 디즈니 파크와 리조트 (Walt Disney Parks and Resorts)
막대한 비용을 투자해 매직밴드를 개발하고 방문객의 움직임을 추적하고 데이터를 수집해 고객 경험의 질을 향상시키기 위해 이용한다.

## 34장. 익스페리언 (Experian)
해커들과 사기꾼들로부터 금융 서비스 회사들을 보호하기 위한 서비스를 제공하고 있다. 악성 부채나 잘못 계산된 보험 등으로 인해 우리가 더 높은 보험료나 더 비싼 이자를 내는 손해를 줄여주기도 한다.

## 35장. 런던교통국 (Transport for London)
런던 대중교통을 이용하는 이용객의 정보를 수집하므로서 런던의 대중교통 네트워크에 새로운 동력을 불어넣는 큰 역할을 한다.
